...
### 页面进度（2026-07-23 校准）
- **已落地真实功能（接后端/真实数据）**：仪表盘 / 凭证管理(3) / 基础账簿(6) / 辅助账簿(6) / 科目管理(1) / 进项发票(1) / 报销单列表(1) / **工资 SalaryList / 固定资产 FixedAsset / 人事合同+公司设置(融入员工详情抽屉) / 税务汇总 TaxSummary / 税务子页(个税申报·印花税·工作台) / 综合报表看板 / 财务报表(资产负债表·利润表·现金流量表·季报)** —— 共约 27+ 真实页
