...
- **最后更新**：2026-07-21
- **Git HEAD**：`3756e76`（main；基线 `ec0096e` + 本次 §9 新增）
- **更新内容**：新增 §9「开发日志 vs STATUS 分工」（判断法 + 两条铁律 + MFR 真实示例），提炼自资产库两份使用规范；修正第 7 节过时引用「见第 9 节」→「见第 8 节」；§1~§8 正文不变。
- **对应提交**：`ec0096e`（7-20 开发日报/端口整改基线）、`3756e76`（本次 §9）
