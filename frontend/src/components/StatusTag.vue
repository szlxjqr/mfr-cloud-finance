...
const MAP: Record<string, { text: string; color: string; bg: string }> = {
  ...
  reviewed: { text: '已复核', color: 'var(--el-color-success)', bg: 'var(--el-color-success-light-9)' },
  ...
  needs_review: { text: '待复核', color: 'var(--el-color-warning)', bg: 'var(--el-color-warning-light-9)' },
