  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'payroll/employee-info', name: 'PayrollEmployeeInfo', component: () => import('@/views/payroll/PayrollEmployeeInfo.vue'), meta: { title: '员工基本信息', group: '工资' } },
        ...
        { path: 'payroll/allocation', name: 'PayrollAllocation', component: () => import('@/views/payroll/SalaryAllocation.vue'), meta: { title: '工资分摊', group: '工资设置' } },
