...
const buildDir = path.join(root, '.invoice-test-build2')
...
for (const name of [
  'flight_itinerary.txt',
  'flight_itinerary_660.txt',
  'flight_itinerary_660_leading1.txt',
  'flight_itinerary_950_ocr.txt',
]) {
  ...
  console.log('===', name, '  consistent =', gate.consistent)
